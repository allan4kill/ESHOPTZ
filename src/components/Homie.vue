            ...
            <div id="home" class="min-h-screen py-4 sm:py-8 pb-28 sm:pb-10 px-2 sm:px-4 relative overflow-hidden">
                ...
                <div class="block lg:hidden">
                    ...
                    <div class="flex justify-center space-x-6 mb-8">
                        <a href="https://www.instagram.com/godobtech?igsh=MTdjbDltZnY5NWx0Yw==" target="_blank" rel="noreferrer" class="text-gray-600 hover:text-rose-500 transition-colors duration-300 p-2">
                ...
                <div class="hidden lg:block">
                    ...
                    <div class="absolute bottom-20 right-8 md:right-14">
                        <div class="flex space-x-4">
                            <a href="https://www.instagram.com/godobtech?igsh=MTdjbDltZnY5NWx0Yw==" target="_blank" rel="noreferrer" class="text-gray-600 hover:text-rose-500 transition-colors duration-300">
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
